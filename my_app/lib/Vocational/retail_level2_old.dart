            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: Color(0xFFFF6B35), // Orange color instead of red
                ...
                if (!gameStarted || isUnderstood)
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(color: Color(0xFFFF6B35), width: 2), // Orange border
                      boxShadow: [
                        BoxShadow(
                    ...
                    child: Column(
                      children: [
                        Text(
                          'Step ${currentStep + 1}: Select the ${currentCategory}',
                          style: const TextStyle(
                            fontSize: 16,
                            fontWeight: FontWeight.bold,
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              color: Colors.white.withOpacity(0.9),
                              borderRadius: BorderRadius.circular(20),
                              border: Border.all(color: Color(0xFFFF6B35), width: 3), // Orange border
                              boxShadow: [
                                BoxShadow(
                                  color: Colors.black.withOpacity(0.2),
                                  blurRadius: 15,
                            ...
                            child: Container(
                              ...
                              child: GridView.builder(
                                gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                                  crossAxisCount: 3,
                                  childAspectRatio: 1.8, // Increased from 1.2 to make images shorter
                                  crossAxisSpacing: 15,
                                  mainAxisSpacing: 15,
                                ),
                                  ...
                                  return GestureDetector(
                                    ...
                                    child: AnimatedContainer(
                                      ...
                                      decoration: BoxDecoration(
                                        ...
                                        border: Border.all(
                                          color: showResult
                                              ? (isCorrectAnswer ? Color(0xFFFF6B35) : Colors.red) // Orange for correct
                                              : Color(0xFFFF6B35), // Orange border
                                        ...
                                        children: [
                                          ...
                                          if (showResult)
                                            Icon(
                                              ...
                                              color: isCorrectAnswer ? Color(0xFFFF6B35) : Colors.red, // Orange for correct
                                              size: 24,
                                            ),
                                        ],
                                      ),
