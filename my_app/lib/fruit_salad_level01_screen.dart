...
class FruitSaladLevel01Screen extends StatefulWidget {
  const FruitSaladLevel01Screen({super.key});

  @override
  State<FruitSaladLevel01Screen> createState() => _FruitSaladLevel01ScreenState();
}

class _FruitSaladLevel01ScreenState extends State<FruitSaladLevel01Screen>
                            ...
                            children: [
                              ...
                              ElevatedButton(
                                onPressed: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(builder: (context) => FruitMatchGame()),
                                  );
                                },
                                style: ElevatedButton.styleFrom(
